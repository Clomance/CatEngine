...
#[derive(Clone,Copy)]
#[repr(transparent)]
pub struct BrushHandle(NonNull<()>);
...
impl Brush{
    ...
    pub fn create_indirect(brush_log:&BrushLog)->Option<BrushHandle>{
        unsafe{
    ...
    /// 
    /// If the function fails, the return value is `None`.
    pub fn create_dib_pattern(packed_bitmap:*const (),colour_format:ColourFormat)->Option<BrushHandle>{
        unsafe{
    ...
    /// 
    /// If the function fails, the return value is `None`.
    pub fn create_hatch(hatch:Hatch,colour:Colour)->Option<BrushHandle>{
        unsafe{
    ...
    /// 
    /// If the function fails, the return value is `None`.
    pub fn create_pattern(bitmap:BitmapHandle)->Option<BrushHandle>{
        unsafe{
    ...
    /// 
    /// If the function fails, the return value is `None`.
    pub fn create_solid(colour:Colour)->Option<BrushHandle>{
        unsafe{
    ...
    pub fn get_system(index:i32)->Option<BrushHandle>{
        unsafe{
    ...
    pub fn destroy(brush:BrushHandle)->bool{
        unsafe{
