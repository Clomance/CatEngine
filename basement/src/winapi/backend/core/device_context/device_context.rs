...
impl DeviceContext{
    ...
    #[inline(always)]
    pub fn create_compatible(context:Option<DeviceContextHandle>)->Option<DeviceContextHandle>{
        unsafe{
    ...
    #[inline(always)]
    pub fn release(window:WindowHandle,context:DeviceContextHandle)->bool{
        unsafe{
...
impl DeviceContext{
    ...
    #[inline(always)]
    pub fn swap_buffers(context:DeviceContextHandle)->bool{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn choose_pixel_format(context:DeviceContextHandle,format:&PixelFormat)->i32{
        unsafe{
...
impl DeviceContext{
    ...
    /// 
    /// If the function fails, the return value is `false`.
    pub fn pattern_blt(context:DeviceContextHandle,[x,y,width,height]:[i32;4],operation:PatternBltOperation)->bool{
        unsafe{
...
impl DeviceContext{
    ...
    #[inline(always)]
    pub fn select_bitmap(context:DeviceContextHandle,handle:BitmapHandle)->Option<BitmapHandle>{
        unsafe{
...
impl DeviceContext{
    ...
    /// 
    /// If the function fails, the return value is `false`.
    pub fn get_brush_origin(context:DeviceContextHandle,point:&mut [i32;2])->bool{
        unsafe{
    ...
    pub fn set_brush_colour(context:DeviceContextHandle,colour:Colour)->ColourResult{
        unsafe{
