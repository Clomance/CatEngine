...
#[repr(transparent)]
pub struct WindowHandle(NonNull<()>);
...
pub struct PaintStruct{
    ...
    pub hdc:device_context::DeviceContextHandle,
    ...
    /// A structure that specifies the upper left and lower right corners of the rectangle in which the painting is requested,
    /// in device units relative to the upper-left corner of the client area.
    pub paint_rectangle:[i32;4],
...
pub unsafe extern "system" fn default_window_procedure_wide(
