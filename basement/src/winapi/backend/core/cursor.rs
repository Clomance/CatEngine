...
impl Cursor{
    ...
    /// If the function fails, the return value is `None`.
    /// To get extended error information, call `WinCore::get_last_error`.
    pub fn copy(cursor:CursorHandle)->Option<CursorHandle>{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn destroy(cursor:CursorHandle)->bool{
        unsafe{
...
impl Cursor{
    ...
    #[inline(always)]
    pub fn load(instance:Option<InstanceHandle>,name:*const u16)->Option<CursorHandle>{
        unsafe{
    ...
    #[inline(always)]
    pub fn load_ansi(instance:Option<InstanceHandle>,name:*const i8)->Option<CursorHandle>{
        unsafe{
            CursorHandle::from_raw(
                LoadCursorA(
                    InstanceHandle::to_raw(instance),
    ...
    #[inline(always)]
    pub fn load_system_cursor(name:SystemCursor)->Option<CursorHandle>{
        unsafe{
            CursorHandle::from_raw(
                LoadCursorA(
                    0 as *mut _,
    ...
    #[inline(always)]
    pub fn load_from_file(name:*const u16)->Option<CursorHandle>{
        unsafe{
            CursorHandle::from_raw(
    ...
    #[inline(always)]
    pub fn load_from_file_ansi(name:*const u8)->Option<CursorHandle>{
        unsafe{
            CursorHandle::from_raw(
                LoadCursorFromFileA(transmute(name))
            )
        }
    }
}
...
impl Cursor{
    ...
    #[inline(always)]
    pub fn set(cursor:Option<CursorHandle>)->Option<CursorHandle>{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn set_system(cursor:Option<CursorHandle>,id:SystemCursorId)->bool{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn get_info(info:&mut CursorInfo)->bool{
        unsafe{
...
impl Cursor{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn clip(rect:Option<&[i32;4]>)->bool{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn get_clip(rect:&mut [i32;4])->bool{
        unsafe{
...
impl Cursor{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn get_position(point:&mut [i32;2])->bool{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn set_position([x,y]:[i32;2])->bool{
        unsafe{
            SetCursorPos(x,y)!=0
        }
    }
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn set_physical_position([x,y]:[i32;2])->bool{
        unsafe{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub fn get_physical_position(point:&mut [i32;2])->bool{
        unsafe{
