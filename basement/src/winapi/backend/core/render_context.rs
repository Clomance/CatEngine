...
#[derive(Clone,Copy)]
#[repr(transparent)]
pub struct RenderContextHandle(NonNull<()>);
...
impl RenderContext{
    ...
    #[inline(always)]
    pub unsafe fn create_context(context:DeviceContextHandle)->Option<RenderContextHandle>{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub unsafe fn delete_context(render_context:RenderContextHandle)->bool{
    ...
    /// To get extended error information, call `WinCore::get_last_error`.
    #[inline(always)]
    pub unsafe fn make_current(context:Option<DeviceContextHandle>,render_context:Option<RenderContextHandle>)->bool{
