...
mod gl_functions{
    ...
    pub unsafe fn glDrawArrays(mode:GLenum,first:GLint,count:GLsizei){
        transmute::<usize,extern "system" fn(GLenum,GLint,GLsizei)>(gl::glDrawArrays)(
            mode,first,count
        )
    }
    pub unsafe fn glDrawArraysInstanced(
        ...
        transmute::<usize,extern "system" fn(GLenum,GLint,GLsizei,GLsizei)>(
    ...
    pub unsafe fn glDrawElements(
        ...
        transmute::<usize,extern "system" fn(GLenum,GLsizei,GLenum,*const GLvoid)>(
            gl::glDrawElements
        )(
    ...
    pub unsafe fn glDrawElementsBaseVertex(
        ...
        transmute::<usize,extern "system" fn(GLenum,GLsizei,GLenum,*const GLvoid,GLint)>(
    ...
    pub unsafe fn glDrawElementsInstancedBaseVertex(
        ...
        transmute::<usize,extern "system" fn(GLenum,GLsizei,GLenum,*const GLvoid,GLsizei,GLint)>(
    ...
    pub unsafe fn glDrawRangeElements(
        ...
        transmute::<usize,extern "system" fn(GLenum,GLuint,GLuint,GLsizei,GLenum,*const GLvoid)>(
    ...
    pub unsafe fn glDrawRangeElementsBaseVertex(
        ...
        transmute::<usize,extern "system" fn(GLenum,GLuint,GLuint,GLsizei,GLenum,*const GLvoid,GLint)>(
    ...
    pub unsafe fn glMultiDrawArrays(
        ...
        transmute::<usize,extern "system" fn(GLenum,*const GLint,*const GLsizei,GLint)>(
    ...
    pub unsafe fn glMultiDrawElements(
        ...
        transmute::<usize,extern "system" fn(GLenum,*const GLsizei,GLenum,*const *const GLvoid,GLint)>(
    ...
    pub unsafe fn glMultiDrawElementsBaseVertex(
        ...
        transmute::<usize,extern "system" fn(GLenum,*const GLsizei,GLenum,*const *const GLvoid,GLint,*const GLint)>(
...
impl Drawing{
    ...
    #[inline(always)]
    pub unsafe fn draw_arrays(start:i32,count:i32,mode:PrimitiveType){
    ...
    /// with the input primitive type of the geometry shader in the currently installed program object.
    #[inline(always)]
    pub unsafe fn draw_arrays_instanced(start:i32,count:i32,instances:i32,mode:PrimitiveType){
