...
Removed user's mouse cursor icon and it's feature.

Removed the `alpha_channel` feature and the related functions and fields.

Added object system for text graphics.
