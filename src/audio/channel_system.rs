...
//! 
//! # переписать
//! В хранилище `tracks_container' содержатся треки. На них ссылаются итераторы в буфере `play_buffer`.
//! 
//! Матрица `iter_indices` хранит списки номеров итераторов для треков в хранилище.
//! Трек `track_container[i]` имеет список итераторов `iter_indices[i]`.
//! 
//! 
//! 
//! в соответствующих списках (`iter_indices`)
